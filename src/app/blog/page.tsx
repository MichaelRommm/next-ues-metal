        ...
        <div className="bg-gray-50 min-h-screen flex flex-col">
            ...
            <main className="flex-grow container mx-auto px-4 py-12">
                <div className="text-center mb-12">
                    <h1 className="text-4xl font-black text-gray-900 mb-4">הבלוג המקצועי</h1>
                    ...
                    {blogPosts.map((post) => (
                        <article key={post.id} className="bg-white rounded-2xl shadow-sm hover:shadow-xl transition-shadow overflow-hidden border border-gray-100 flex flex-col">
                            ...
                            <div className="p-6 flex-grow flex flex-col">
                                ...
                                <Link href={`/blog/${post.slug}`} className="text-[#ff6b00] font-bold hover:underline self-start mt-auto">
                                    קרא עוד &larr;
                                </Link>
                            </div>
                        </article>
