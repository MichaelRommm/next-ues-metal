    ...
    },
    {
        ...
        content: `
            ...
            <div class="bg-gray-50 border-r-4 border-gray-500 p-4 mb-4">
                <strong>טווח מחירים (אלקטרודה):</strong> 450 - 1,200 ₪
            </div>
            
            <p class="mb-2"><strong>רתכת MIG (CO2):</strong> הרוד שדרוג המומלץ ביותר. ריתוך ב-MIG (עם גז וסליל) הוא מהיר הרבה יותר, כמעט ללא עשן וללא שלקה לניקוי – מה שחוסך המון זמן השחזות וגימורים. אמנם הציוד הראשוני יקר יותר (מכונה + בלון), אבל הנוחות שווה כל שקל.</p>
             <div class="bg-gray-50 border-r-4 border-gray-500 p-4 mb-2">
                <strong>טווח מחירים (MIG משולבת):</strong> 1,500 - 3,500 ₪ (לא כולל בלון)
            </div>
            ...
            <ul class="list-disc list-inside mb-4 space-y-2 text-gray-900">
                <li><strong>מגן פנים שקוף (Full Face Shield):</strong> להגנה בזמן חיתוך והשחזה.</li>
                <li><strong>כפפות ריתוך עור:</strong> עבות וארוכות להגנה מחום וגיצים.</li>
                <li><strong>אטמי אוזניים / אוזניות מגן:</strong> השחזה היא עבודה רועשת מאוד שפוגעת בשמיעה לאורך זמן.</li>
                <li><strong>נעלי עבודה עם כיפת מגן:</strong> ברזל כבד תמיד נופל על הרגל. כיפת מגן תציל את האצבעות שלכם.</li>
                <li><strong>ביגוד מתאים:</strong> רק כותנה מלאה! המנעו לחלוטין מבגדים סינטטים שנמסים ונדבקים לעור, או מ"בגדי שבת" שחבל שיהרסו בחורים קטנים.</li>
            </ul>

            <h3 class="text-2xl font-bold text-[#ff6b00] mb-3 mt-8">5. חומרים מתכלים (אל תשכחו לקנות)</h3>
             <ul class="list-disc list-inside mb-4 space-y-2 text-gray-900">
                <li><strong>אלקטרודות:</strong> סוג Z-11 (או 6013) בקוטר 2.5 מ"מ הן המומלצות ביותר למתחילים ולעבודות כלליות.</li>
                <li><strong>לרתכי MIG:</strong> סליל חוט (0.8 מ"מ לעבודות כלליות) + מכל גז (תערובת CO2 וארגון לריתוך פלדה).</li>
            ...
            <div class="bg-gray-50 border-r-4 border-gray-500 p-4 my-2">
                ...
                דיוק במדידה וחיתוך חוסך שעות של תיקונים בריתוך.
            </div>
            ...
            <div class="text-xl font-bold bg-[#ff6b00] text-white p-6 rounded-xl shadow-md text-center">
                תתחילו בקטן, תשמרו על הבטיחות, ותתקדמו לאט. בהצלחה!
            </div>
        `
    }
];
