    ...
    },
    {
        ...
        content: `
            ...
            <h3 class="text-2xl font-bold text-[#ff6b00] mb-3 mt-8">7. כלי עבודה כלליים (הבסיס שחייבים)</h3>
             <p class="mb-4">מעבר לכלים הכבדים, יש את הכלים הקטנים שאי אפשר בלעדיהם:</p>
            <ul class="list-disc list-inside mb-4 space-y-2 text-gray-900">
                <li>פטיש טוב (לשבירת שלקה וליישור).</li>
                <li>פלייר, קאטר, וג'פקה (פלאייר פטנט) לאחיזה.</li>
                <li>סט מפתחות פתוח/סגור ומפתחות אלן.</li>
                <li>מברגות (אימפקט ומקדחה).</li>
            </ul>
            <div class="bg-gray-50 border-r-4 border-gray-500 p-4 my-2">
                <strong>תקציב לסט כללי:</strong> כ-500 - 1,000 ₪
            </div>
